...
Extract the feature/module name from changed file paths or the work context. Use lowercase, hyphenated names. Examples: `resume-editor`, `auth`, `payment`, `dashboard`.

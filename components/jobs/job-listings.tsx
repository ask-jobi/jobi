...
export function JobListings({
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    const matchesContract =
      !contractType ||
      job.type.toLowerCase().includes(contractType.toLowerCase())
      ...
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent>
              <SelectItem value="relevance" icon={ArrowUpDown}>
                By relevance
              </SelectItem>
              <SelectItem value="date" icon={ArrowUpDown}>
                By date
              </SelectItem>
              <SelectItem value="salary" icon={ArrowUpDown}>
                By salary
              </SelectItem>
              <SelectItem value="company" icon={ArrowUpDown}>
                By company
              </SelectItem>
            </SelectContent>
          </Select>
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      <div className="flex gap-1.5 flex-wrap">
                        {job.badges.map((badge, index) => (
                          <Badge
                            key={index}
                            className={`${badge.color} border-0 text-xs`}
                          >

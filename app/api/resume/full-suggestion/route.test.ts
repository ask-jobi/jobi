...
const mockGenerateAISuggestionQueue = generateAISuggestionQueue as jest.MockedFunction<typeof generateAISuggestionQueue>;
  ...
  const mockSuggestions: AISuggestionQueue = [
    {
      ...
      optimizedContent: 'Frontend Developer at Tech Corp, improved performance by 30%',
      ...
      const complexSuggestions: AISuggestionQueue = [
        {
          ...
          optimizedContent: 'Bachelor of Computer Science with honors (GPA: 3.8/4.0)',
          highlight: ['GPA', '3.8'],
        },
        {
          section: 'employment',
          ...
          optimizedContent: 'Senior Frontend Developer at Tech Corp, led team of 5 developers',

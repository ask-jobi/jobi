...
export default function LandingPage() {
  ...
  return (
    <LandingPageLayout>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={user ? "/dashboard" : "/auth/sign-up"}>
              <Button
                size="lg"
                className="text-lg px-8 relative bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-md overflow-hidden group border-0"
              >
                {/* 持续的背景白色光晕 */}
      ...
      <section
        id="problem"
        className="relative py-24 md:py-32 bg-gradient-to-b from-background via-foreground/[0.02] to-background"
      >
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl font-bold">
                    {t("landingPage.features.feature1")}
                  </h3>
                </div>
            ...
            >
              ...
              <div className="space-y-6 md:order-2 order-1">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl font-bold">
                    {t("landingPage.features.feature2")}
                  </h3>
                </div>
                <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            >
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-3xl font-bold">
                    {t("landingPage.features.feature3")}
                  </h3>
                </div>
                <p className="text-muted-foreground text-lg leading-relaxed">
